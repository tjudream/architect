...
* 编写测试用例测试这个算法，测试 100 万 KV 数据，10 个服务器节点的情况下，计算这些
 KV 数据在服务器上分布数据的标准差，以评估算法的存储负载不均衡性

### 答：
* 计算了10次，每次计算 150~200 个虚拟节点
* 标准差最小的虚拟节点数为 158， 最小的一次标准差为 5786.32

* 计算结果
```text
150~200个虚拟节点中: 最优标准差 = 5944.18, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 6125.13, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5883.81, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5885.00, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5971.10, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5935.90, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5786.32, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5947.79, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5836.97, 最优标准差的虚拟节点数 = 158
150~200个虚拟节点中: 最优标准差 = 5951.52, 最优标准差的虚拟节点数 = 158
```
